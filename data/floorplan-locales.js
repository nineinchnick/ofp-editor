locale.en = {
    ...
    "just_edited": "You just edited OpenFloorPlan!",
    "browser_notice": "This editor is supported in Firefox, Chrome, Safari, Opera, and Internet Explorer 9 and above. Please upgrade your browser or use Potlatch 2 to edit the map.",
    "view_on_osm": "View on OSM",
    "zoom_in_edit": "zoom in to edit the map",
    "logout": "logout",
    "loading_auth": "Connecting to OpenFloorPlan...",
    "report_a_bug": "report a bug",
    "commit": {
        "title": "Save Changes",
        "description_placeholder": "Brief description of your contributions",
        "message_label": "Commit message",
        "upload_explanation": "The changes you upload as {user} will be visible on all maps that use OpenFloorPlan data.",
        "save": "Save",
        "cancel": "Cancel",
        "warnings": "Warnings",
        "modified": "Modified",
    ...
    "inspector": {
        ...
        "reference": "View on OpenFloorPlan Wiki →",
    ...
    "save": {
        "title": "Save",
        "help": "Save changes to OpenFloorPlan, making them visible to other users.",
        "no_changes": "No changes to save.",
        "error": "An error occurred while trying to save",
        "uploading": "Uploading changes to OpenFloorPlan.",
        "unsaved_changes": "You have unsaved changes"
    },
    "splash": {
        "welcome": "Welcome to the iD OpenFloorPlan editor",
    ...
    "presets": {
        ...
        "presets": {
            ...
            "room/office": {
                "name": "Office",
                "terms": "office,desk,administration,computer"
            },
            "room/storage": {
                "name": "Storage",
                "terms": "storage,closet"
            },
            "room/conference": {
                "name": "Conference / Classroom",
                "terms": "conference,meeting,classroom,presentation"
            },
            "room/restroom": {
                "name": "Restroom",
                "terms": "restroom,bathroom,toilet,washroom,WC"
            },
            "room/serverroom": {
                "name": "Server Room",
                "terms": "servers, routers"
            },
            "room/lockers": {
                "name": "Lockers",
                "terms": "locker"
            ...
            "room/auditorium": {
                "name": "Auditorium",
                "terms": "auditorium, presentation, meeting"
            },
            "room/utility": {
                "name": "Utility Room",
                "terms": "utility, closet, industrial, mechanical"
            },
            "room/bedroom": {
                "name": "Bedroom",
                "terms": "bed,hotel,motel"
            },
            "circulation": {
                "name": "circulation",
                "terms": "circulation"
